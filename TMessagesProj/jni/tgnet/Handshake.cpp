    ...
    if (authNonce->isEqualTo(result->nonce.get())) {
        ...
        if (currentDatacenter->isCdnDatacenter) {
            ...
            if (serverPublicKeys.empty()) {
                // Custom server RSA public key
                serverPublicKeys.emplace_back("-----BEGIN RSA PUBLIC KEY-----\n"
                                              "MIIBCgKCAQEAtPj/7SZJ2cVq1tk898M4blPOqoB2v32W36RXdInYGhKMNFFkjOrn\n"
                                              "MaLt82M6PJ3fmRkRiIUEo2ZBkBEdNJNRk9oWmsg6OjkdWLJmJmkSl/xX3z61lt0n\n"
                                              "dAGNubjVGK5FT7Jxp7pZeHyUDV078r7oUSBI/dI0j7wljNf8kJzjGGkJPP7weWew\n"
                                              "zXkSSS4Q8QSxD7IwegOJp5gBHQleJwLfM65K1r8PPbH+FoQ+MoHsrAQThHYxMlTR\n"
                                              "QR54781gVxomzaVhZ6ov/yE3pWM4waRO0HglaNSOCK3Ib+yaBHCeAC8ojApo1PHj\n"
                                              "iA7eJ3MvXwY65+ncUN2x1a4ELDoxibosfQIDAQAB\n"
                                              "-----END RSA PUBLIC KEY-----");
                serverPublicKeysFingerprints.push_back(0xaa8c26828ac8d64c);
            }
